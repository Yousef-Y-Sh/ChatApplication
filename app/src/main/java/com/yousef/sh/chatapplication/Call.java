...
public class Call extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SUid = Integer.parseInt(getIntent().getStringExtra(Utils.Uid).toString());
    ...
    private void joinChannel() {
        ...
        mRtcEngine.joinChannel(RtcToken, ChannelName, "Extra Optional Data", SUid); // if you do not specify the uid, we will generate the uid for you
    }
